            ...
            '<div class="desktop-header" id="desktopHeader">' +
                ...
                '<div class="dh-notify-wrap">' +
                    ...
                    '<div class="dh-notify-dropdown" id="dhNotifyDropdown">' +
                        '<div class="dn-header"><button class="dn-tab active" onclick="dhSwitchTab(event,\'revenue\')">收益<span style="display:inline-block;width:6px;height:6px;border-radius:50%;background:#ff2d55;margin-left:5px;vertical-align:middle"></span></button><button class="dn-tab" onclick="dhSwitchTab(event,\'social\')">互动<span style="display:inline-block;width:6px;height:6px;border-radius:50%;background:#ff2d55;margin-left:5px;vertical-align:middle"></span></button></div>' +
                        '<div class="dn-scroll">' +
                            '<!-- IP 被签约 -->' +
